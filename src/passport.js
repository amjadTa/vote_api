...
const cipher = require('./api/general/auth/cipherHelper');
const UserService = require('./api/general/user/userService');
...
(tz, password, cb) => {
  userService
    ...
    .then(user => {
      ...
      return cb(null, { id: user.tz, role: user.role, user_name: user.user_name }, { message: 'Logged In Successfully' });
    })
